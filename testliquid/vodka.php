...
<body>
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
                ...
                <div class="attr-nav">
                    ...
                    <li>
                          ...
                          if(!isset($_SESSION['userid'])){
                            echo '<a id="signin" class="btn btn-default hvr-hover btn-cart">Sign In</a>';
                          }
                        ?>
                    </li>
                    </ul>
            ...
            <div class="side">
                ...
                <div>
                    <a href="vodka.php?action=empty" class="btn btn-default hvr-hover btn-cart">Empty Cart</a>
                </div>
                <?php
                    if(isset($_SESSION["cart_item"])){
                        $total_quantity = 0;
                ...
                <li class="cart-box">
                    ...
                    ?>
                        <li>
                            ...
                            <p style="text-align:center;"><a href="vodka.php?action=remove&code=<?php echo $item["code"]; ?>"><img src="images/icon-delete.png" alt="Remove Item" style="width:25px;height:25px;">Remove Item</a></p>
                            <?php
                                $total_quantity += $item["quantity"];
                ...
                <a onClick="checklogin(check)" class="btn btn-default hvr-hover btn-cart">Checkout</a>
            </div>
            <!-- End Side Menu -->
        </nav>
        <!-- End Navigation -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Vodka </li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="id">
                ...
                <tr>
                    <td id="align">
                    <?php
                        $product_array = $db_handle->runQuery("SELECT * FROM vodka ORDER BY id ASC");
                        if (!empty($product_array)) { 
                            foreach($product_array as $key=>$value){
                    ?>
                        <div class="itemcontainer">
                        <form method="post" action="vodka.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
                            <div class="image">
