...
<body>
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            ...
            <div class="side">
                ...
                <div>
                    <a href="wine.php?action=empty" class="btn btn-default hvr-hover btn-cart">Empty Cart</a>
                </div>
                <?php
                    if(isset($_SESSION["cart_item"])){
                        $total_quantity = 0;
                ...
                <li class="cart-box">
                    ...
                    ?>
                        <li>
                            ...
                            <p style="text-align:center;"><a href="wine.php?action=remove&code=<?php echo $item["code"]; ?>"><img src="images/icon-delete.png" alt="Remove Item" style="width:25px;height:25px;">Remove Item</a></p>
                            <?php
                                $total_quantity += $item["quantity"];
    ...
    <!-- Start Whisky Page  -->
                ...
                <tr>
                    <td id="align">
                    <?php
                        $product_array = $db_handle->runQuery("SELECT * FROM wine ORDER BY id ASC");
                        if (!empty($product_array)) { 
                            foreach($product_array as $key=>$value){
                    ?>
                        <div class="itemcontainer">
                        <form method="post" action="wine.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
                            <div class="image">
